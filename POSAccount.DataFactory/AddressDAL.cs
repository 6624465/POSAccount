...
namespace POSAccount.DataFactory
{
    public class AddressDAL
    {
        ...
        {
            return db.ExecuteSprocAccessor(DBRoutine.LISTADDRESS,
                                           MapBuilder<Address>.MapAllProperties()
                                           .Build()).ToList();
        }
        ...
        public bool Save<T>(T item) where T : IContract
        {
            ...
            try
            {
                ...
                db.AddInParameter(savecommand, "AddressId", System.Data.DbType.Int64, address.AddressId);
                ...
                db.AddInParameter(savecommand, "IsBilling", System.Data.DbType.Boolean, address.IsBilling == null ? true : address.IsBilling);
        ...
        public bool Delete<T>(T item) where T : IContract
        {
            ...
            try
            {
                ...
                db.AddInParameter(deleteCommand, "AddressId", System.Data.DbType.String, address.AddressId);
        ...
        public IContract GetItem<T>(IContract lookupItem) where T : IContract
        {
            ...
            var addressItem = db.ExecuteSprocAccessor(DBRoutine.SELECTADDRESS,
                                                    MapBuilder<Address>.MapAllProperties()
                                                    .Build(),
                                                    ((Address)lookupItem).AddressId).FirstOrDefault();
