...
namespace POSAccount.Controllers
{
  //[Authorize]
    public class AccountController : Controller
    {
        ...
        {
            var brancList = new POSAccount.BusinessFactory.BranchBO().GetList().Where(x => x.CompanyCode == companyCode).ToList();
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            var compist = new POSAccount.BusinessFactory.CompanyBO().GetList();
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            var currentUser = lstUsers.Where(ur => ur.UserID.ToLower() == model.UserID.ToLower() && ur.Password.ToLower() == model.Password.ToLower()).FirstOrDefault();
            ...
            if (currentUser != null)
            {
                ...
                Utility.USERROLE = currentUser.RoleCode;
