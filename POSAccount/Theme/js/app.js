...
var App = function() {
    ...
    //var uiHelperTableToolsSectionsannounce = function () {
    //    var $table = jQuery('.js-table-sections-announce');
    //    var $tableRows = jQuery('.js-table-sections-anounce-header > tr', $table);
